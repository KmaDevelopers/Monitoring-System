...
Ext.define('Ext.grid.column.Column', {
    ...
    setPadding: function(headerContext, availableHeight) {
        var me = this,
     ...
     * if to do so would leave one side with no visible columns, or the width of the locked grid would be too
     * wide to leave a valid scrollable side. There must be at least 30 pixels on the scrollable side.
     *
