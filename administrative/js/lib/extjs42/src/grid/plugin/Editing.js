...
Ext.define('Ext.grid.plugin.Editing', {
    ...
    getEditingContext: function(record, columnHeader) {
        var me = this,
            ...
            rowIdx, colIdx,
            headerCt = columnHeader.getOwnerHeaderCt ? columnHeader.getOwnerHeaderCt() : grid.headerCt;
        ...
        columnHeader = headerCt.getVisibleHeaderClosestToIndex(Ext.isNumber(columnHeader) ? columnHeader : columnHeader.getIndex());
