...
Ext.define('Ext.grid.plugin.BufferedRenderer', {
    ...
    unbindStore: function() {
        ...
        this.view.getStoreListeners = this.store = null;
    },
    ...
    onStoreClear: function() {
        ...
        if (me.view.rendered && !me.store.isDestroyed) {
            ...
            me.position = 0;
            me.lastScrollDirection = me.scrollOffset = me.rowHeight = null;
        }
    },
    ...
    onViewResize: function(view, width, height, oldWidth, oldHeight) {
        ...
        if (!oldHeight || height !== oldHeight) {
            ...
            if (!me.viewSize || me.rowHeight != oldRowHeight) {
    ...
    onViewScroll: function(e, t) {
        ...
        if (!me.disabled) {
            ...
            // Keep other side synced immediately if there's no rendering work to do.
            else if (me.lockingPartner && me.lockingPartner.scrollTop !== me.scrollTop) {
