...
Ext.define('Ext.view.Table', {
    ...
    tableTpl: [
        '<table role="presentation" id="{view.id}-table" class="' + Ext.baseCSSPrefix + '{view.id}-table ' + Ext.baseCSSPrefix + 'grid-table" border="0" cellspacing="0" cellpadding="0" style="{tableStyle}" tabIndex="-1">',
    ...
    */
    ...
    focus: function() {
        var focusedRow = this.getFocusEl();
        if (focusedRow) {
